...
<head>
    ...
    <script src="ForgotPassword/forgotJS.js" defer></script>
</head>
<body>
<div class="page">
    <div class="container">
        ...
        <div class="right">
            ...
            <div class="form">
                <form action="recover" method="post">
                    ...
                    <label for="securityQuestion">Security Question: What is your birth city?</label>
                    <input type="text" id="securityQuestion" name="securityQuestion" placeholder="Enter your birth city:" required>
