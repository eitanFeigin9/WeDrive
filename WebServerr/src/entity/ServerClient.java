...
public class ServerClient {
    ...
    public boolean addNewDrivingEvent(String eventName, int maxCapacity, String pickupCity, int fuelReturnsPerPerson, double latitude, double longitude, double maxPickupDistance){

        if(!checkDrivingEventExists(eventName)){
            drivingEvents.put(eventName, new DriverRide(eventName,maxCapacity,pickupCity,fuelReturnsPerPerson, latitude, longitude,maxPickupDistance));
            return true;
        }
        return false;
    }
